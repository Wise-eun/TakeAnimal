   ...
   public  enum dir
    ...
    public IEnumerator MoveToPosition(dir direction)
    {
        ...
        if (direction.Equals(dir.forward))
        {
            ...
            jump_position = new Vector3(transform.position.x, height + 1.5f, transform.position.z);
            move_position = new Vector3(transform.position.x + 1, height+1.5f, transform.position.z);
        ...
        else if (direction.Equals(dir.right))
        {
            ...
            jump_position = new Vector3(transform.position.x, height + 1.5f, transform.position.z);
            move_position = new Vector3(transform.position.x, height + 1.5f, transform.position.z - 1);
